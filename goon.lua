...
local function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 600, 0, 350) or UDim2.new(0, 600, 0, 550)}):Play()
...
local function Unhide()
	...
	Main.Visible = true
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = useMobileSizing and UDim2.new(0, 650, 0, 275) or UDim2.new(0, 650, 0, 475)}):Play()
	TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 600, 0, 45)}):Play()
...
local function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 645, 0, 45)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Size = UDim2.new(0, 645, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.Icon and Settings.Icon ~= 0 and Topbar:FindFirstChild('Icon') then
		...
		Topbar.Title.Position = UDim2.new(0, 35, 0.5, 0)
